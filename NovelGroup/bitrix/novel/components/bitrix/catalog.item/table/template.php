...
if (isset($arResult['ITEM']))
{
	...
	?>
<div class="col-md-6 product_item_col">
	<div class="wow animate__fadeInUp product-item-container<?=(isset($arResult['SCALABLE']) && $arResult['SCALABLE'] === 'Y' ? ' product-item-scalable-card' : '')?>"
