...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="carousel_item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<div class="container">
			<div class="carousel_item_content offset-xxl-2">
				<div data-splitting class="carousel_item_title -st-500 -fs-80"><?echo $arItem["NAME"]?></div>
				<div class="carousel_item_btn"><a href="<?=$arItem['PROPERTIES']['LINK']['VALUE']?>" class="btn btn-link"><?=$arItem['PROPERTIES']['LINK_TITLE']['VALUE']?></a></div>
			</div>
		</div>
	</div>
