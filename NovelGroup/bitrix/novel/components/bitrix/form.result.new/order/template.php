...
<div class="popup_wrap">
  ...
  <div class="popup_body">
    ...
    <?
      ...
      $mainclass = 'id="'.$FIELD_SID.'" class="form-control '.$isphone.'" placeholder="'.$arQuestion["CAPTION"].$required.'"';
      ?>
...
<?if(SITE_ID == 'en'){?>
  <script>
    let name = $("h1").text();
    console.log(name);
    document.getElementById("SIMPLE_QUESTION_138").value = name;
    $('#SIMPLE_QUESTION_138').attr('readonly','readonly');
...
<?}else{?>
  <script>
    let name = $("h1").text();
    console.log(name);
    document.getElementById("SIMPLE_QUESTION_153").value = name;
    $('#SIMPLE_QUESTION_153').attr('readonly','readonly');
