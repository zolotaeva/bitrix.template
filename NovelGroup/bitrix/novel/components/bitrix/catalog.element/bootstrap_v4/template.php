...
<div class="bx-catalog-element<?=$themeClass?>" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
  ...
  <div class="col-md-4">
    <div class="card_image">
      <img src="<?=$actualItem['MORE_PHOTO'][0]['SRC']?>" alt="<?=$alt?>" title="<?=$title?>"<?=($key == 0 ? ' itemprop="image"' : '')?>>
			...
			<div class="product-item-detail-slider-container d-none" id="<?=$itemIds['BIG_SLIDER_ID']?>">
		...
		?>
		<div class="<?=($showBlockWithOffersAndProps ? "col-md-8" : ""); ?>">
								...
								case 'props':
									if ($showPropsBlock)
									{
										?>
											...
											{
												?>
												<ul class="product-item-detail-properties card_short_info -fs-14">
													<?
													foreach ($mainBlockProperties as $property)
													{
														?>
														<li class="product-item-detail-properties-item short_info_row">
															<span class="short_info_col"><?=$property['NAME']?></span>
															<!-- <span class="product-item-detail-properties-dots"></span> -->
															<span class="short_info_col"><?=(is_array($property['DISPLAY_VALUE'])
            ...
            <div class="card_info_btn">
              <div class="card_info_btn_row">
                <a data-fancybox="" data-src="#question" href="javascript:;" class="btn btn-secondary"><?echo GetMessage("CT_BCE_CATALOG_ASC_BTN")?></a>
                <a data-fancybox="" data-src="#order" href="javascript:;" class="btn btn-secondary"><?echo GetMessage("CT_BCE_CATALOG_ORDER_BTN")?></a>
              </div>
            </div>
					</div>
					<?
				...
				<div class="<?=($showBlockWithOffersAndProps ? "" : ""); ?>">
  ...
  <div class="card_info_content -fs-18">
	...
	<!--Small Card-->
	<div class="p-2 product-item-detail-short-card-fixed d-none" id="<?=$itemIds['SMALL_CARD_PANEL_ID']?>">
	...
	<!--Top tabs-->
	<div class="pt-2 pb-0 product-item-detail-tabs-container-fixed d-none " id="<?=$itemIds['TABS_PANEL_ID']?>">
		<ul class="product-item-detail-tabs-list">
			<?
			if ($showDescription)
			{
