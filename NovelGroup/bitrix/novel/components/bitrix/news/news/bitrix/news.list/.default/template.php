...
<div class="news_wrap_row">
	<div class="news_nav_panel">
		<div class="news_nav -fs-15">
<?

	$arSections = CIBlockSection::GetList(Array("SORT"=>"ASC"), Array("ACTIVE" => "Y", "IBLOCK_ID" => 1),false, Array('ID', 'NAME', 'SECTION_PAGE_URL'),false);
	while ($arSection = $arSections->GetNext()){?>
	
		<a href="<?=$arSection['SECTION_PAGE_URL']?>" class="news_nav_item"><?=$arSection['NAME']?></a>
	<?}
