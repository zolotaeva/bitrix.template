...
?>
<div class="card_recomended">
  <div class="container">
    <div class="card_recomended_top">
      <div class="section_title  -fs-40"><? echo GetMessage('CT_BCS_CATALOG_MESS_RECOMMEND_TITLE')?></div> 
      <div class="card_recomended_nav">
    ...
    <div class="catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
      ...
      if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
      {
        ...
        ?>
        <!-- items-container data-entity="items-row"-->
        <div class="recomended_carousel -fs-25" >
        <?
        foreach ($arResult['ITEM_ROWS'] as $rowData)
        {
          $rowItems = array_splice($arResult['ITEMS'], 0, $rowData['COUNT']);
          ?>
          <div class="slide_item" data-entity="items-row">
            <?
