...
$MESS["CT_BCS_CATALOG_MESS_SORT_NAME"] = "Сортировать по наименованию";
$MESS["CT_BCS_CATALOG_MESS_SORT_PRICE"] = "Сортировать по цене";
$MESS["CT_BCS_CATALOG_MESS_SORT_POPULAR"] = "Сортировать по популярности";
?>