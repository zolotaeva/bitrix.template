...
$APPLICATION->SetPageProperty("body_class", "catalog card");
...
?>
<!-- <div class='row'> -->
	<div class='<?=($isSidebar ? 'col-md-9 col-sm-8' : '')?>'>
		<?
...
if($section = $res->GetNext())
 // echo $section['IBLOCK_SECTION_ID']; 
?>
...
$arFilter = Array("IBLOCK_ID"=>$arParams["IBLOCK_ID"], "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y", "ID"=>$elementId);
...
<?if($arProps['BOTTOM_TEXT']['~VALUE']['TEXT'] != ""){?>
<div class="content_bottom">
  <div class="container">
    <div class="content_bottom_wrap -fs-20">
      <div class="section_bottom_title -st-500 -fs-60"><?=$arProps['BOTTOM_TITLE']['VALUE']?></div>
      <div class="content_bottom_row row">
        <div class="col-md-8 col-xl-7">
          <div class="section_bottom_subtitle -fs-25"><?=$arProps['BOTTOM_SUBTITLE']['VALUE']?></div>
          <div class="section_bottom_desc">
            <?=$arProps['BOTTOM_TEXT']['~VALUE']['TEXT']?>
          </div>
        </div>
        <div class="col-md-4 col-xl-5">
          <div class="section_bottom_img">
            <? 
            $bottom_img = CFile::ResizeImageGet($arProps['BOTTOM_IMG']['VALUE'], array('width'=>542, 'height'=>465), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
