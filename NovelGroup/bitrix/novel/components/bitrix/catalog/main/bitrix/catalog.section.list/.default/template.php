...
{
?>
<div class="catalog_items -fs-25 <?// echo $arCurView['LIST']; ?>">
<?
	switch ($arParams['VIEW_MODE'])
	{
		case 'LINE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="catalog_item_title" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"><? echo $arSection['NAME']; ?></a>
