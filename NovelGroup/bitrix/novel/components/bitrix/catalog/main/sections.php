...
<div class="lines"></div>
<div class="catalog_wrap pl-js">
	<div class="catalog_row row g-0">
...
<?
  if(SITE_ID == "en"){
    $APPLICATION->IncludeComponent("bitrix:main.include", "", Array(
      "AREA_FILE_SHOW" => "file",
      "PATH" => SITE_TEMPLATE_PATH . "/inc_en/catalog_carousel.php",
    ...
    $APPLICATION->IncludeComponent("bitrix:main.include", "", Array(
      "AREA_FILE_SHOW" => "file",
      "PATH" => SITE_TEMPLATE_PATH . "/inc/catalog_carousel.php",
      "EDIT_TEMPLATE" => "include_areas_template.php"
      ), false
    );
  }?>
...
<div class="catalog_text -fs-18">
<?
  if(SITE_ID == "en"){
    $APPLICATION->IncludeComponent("bitrix:main.include", "", Array(
      "AREA_FILE_SHOW" => "file",
      "PATH" => SITE_TEMPLATE_PATH . "/inc_en/catalog_text.php",
      "EDIT_TEMPLATE" => "include_areas_template.php"
      ), false
    );
}else{
  $APPLICATION->IncludeComponent("bitrix:main.include", "", Array(
    "AREA_FILE_SHOW" => "file",
    "PATH" => SITE_TEMPLATE_PATH . "/inc/catalog_text.php",
    "EDIT_TEMPLATE" => "include_areas_template.php"
    ), false
  );
}
...
$prop = CIBlockElement::GetProperty($ar_res['IBLOCK_ID'], $ar_res['ID'], "sort", "asc", array("CODE" => "SUBTITLE"));
if ($ob = $prop->GetNext()){$subtitle = $ob['VALUE'];}?>
	 
<div class="content_bottom">
	<div class="container">
		<div class="content_bottom_wrap offset-xxl-2 -fs-20">
			<div class="section_bottom_title -st-500 -fs-60"><?=$ar_res['NAME']?></div>
			<div class="content_bottom_row row">
				<div class="col-md-8 col-xl-7">
					<div class="section_bottom_subtitle -fs-25"><?=$subtitle?></div>
				...
				<div class="col-md-4 col-xl-5">
					<div class="section_bottom_img">
						<?$img = CFile::ResizeImageGet($ar_res['PREVIEW_PICTURE'], array('width'=>800, 'height'=>520), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
						<img src="<?=$img['src']?>" alt="">
					</div>
				</div>
			</div>
...
<?if(SITE_ID == "en"){
  $APPLICATION->IncludeComponent("bitrix:main.include", "", Array(
  "AREA_FILE_SHOW" => "file",
  "PATH" => SITE_TEMPLATE_PATH . "/inc_en/section_form.php",
  "EDIT_TEMPLATE" => "include_areas_template.php"
  ), false
  );
}else{
  $APPLICATION->IncludeComponent("bitrix:main.include", "", Array(
    "AREA_FILE_SHOW" => "file",
    "PATH" => SITE_TEMPLATE_PATH . "/inc/section_form.php",
    "EDIT_TEMPLATE" => "include_areas_template.php"
    ), false
    );
}
